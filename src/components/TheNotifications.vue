  ...
  <div class="absolute right-10 bottom-10 space-y-3 notifi-container">
    <transition-group name="notification">
      <div class="toast" role="alert" v-if="notification">
        ...
        <div class="toast-icon text-red-500 bg-red-100" v-if="notification.state === 'danger'">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
        </div>
        <div class="toast-icon text-orange-500 bg-orange-100" v-if="notification.state === 'warning'">
...
.toast {
  @apply flex items-center w-full w-[380px] p-4 text-gray-500 bg-white rounded-lg shadow;
  .toast-icon {
